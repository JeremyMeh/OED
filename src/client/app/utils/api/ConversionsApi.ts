...
export default class ConversionsApi {
	...
	public async deleteConversion(sourceId: string, destinationId: string):Promise<Conversion>
	{
		return await this.backend.doPostRequest<Conversion>('/api/conversions/delete', {sourceId, destinationId})
	};
